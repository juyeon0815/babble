<template>
  ...
  <h1>🙋 Who&#x27;s Team Ba:bble?</h1>
    <img :class="resize" :src="require('@/assets/images/team_bubble_members.png')" />
  ...
  <ol type="1" class="numbered-list" start="1">
    <li>원하는 주제의 이야기 방을 생성하세요.
      <ul class="bulleted-list">
        <li>로그인한 사용자는 원하는 이야기 방을 생성할 수 있습니다. 방 제목, 설명을 기입하고 썸네일로 지정할 사진을 업로드 후 분류 카테고리를 지정합니다.</li>
      </ul>
      <ul class="bulleted-list">
        <li>원하는 해시테그 키워드를 5개까지 설정할 수 있습니다. 해당 키워드 구독을 원하는 사용자에게 이야기 방 알림 메일이 전송됩니다!</li>
      </ul>
    </li>
  </ol>
  <ol type="1" class="numbered-list" start="2">
    <li>생성된 이야기 방에 참여하세요.
      ...
      <ul class="bulleted-list">
        <li>로그인한 사용자는
          <ul class="bulleted-list">
            <li>대기실에서 방송 입장 전 카메라 / 음성 송출 여부를 지정.후 방에 입장합니다. 방 입장 후에도 송출 여부를 변경할 수 있습니다.</li>
          </ul>
          <ul class="bulleted-list">
