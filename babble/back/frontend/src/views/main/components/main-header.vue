  ...
  <el-row
    ...
    <div class="hide-on-small">
      ...
      <div class="tool-wrapper">
        ...
        <div class="button-wrapper" v-show="!state.info" >
          <el-button @click="clickJoin"><div class="el-icon-circle-plus-outline"></div>회원가입</el-button>
          <el-button type="primary" @click="clickLogin"><div class="el-icon-key"></div>로그인</el-button>
        </div>
        <div class="button-wrapper" v-show="state.info" >
          <el-button @click="clickMyinfo">내정보</el-button>
          <el-button type="primary" @click="clickLoout">로그아웃</el-button>
        </div>
      </div>
...
export default {
  ...
  // created: function() { //페이지 진입시 실행하나유?
  //     const vm = this;
  //     if(localStorage.getItem('jwt')){ //토큰 존재 시
  //         const store = useStore()
  //         store.dispatch('root/getInfo', localStorage.getItem('jwt')).then(function (result) {
  //           console.log("!!!!!!!!!!!!!!!",result)
  //           vm.info = true;
  //         })
  //         .catch(function (err) {
