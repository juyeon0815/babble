...
<div class="tab">
  ...
  <el-table :data="state.historyData" class="table" ref="filterTable" :default-sort="{prop: 'createDate', order: 'descending'}" empty-text="No Data">
    <el-table-column prop="title" label="방 제목">
    </el-table-column>
    <el-table-column prop="category" label="카테고리"
    :filters="[{ text: 'sports', value: 'sports' }, { text: 'cooking', value: 'cooking' }, { text: 'handcraft', value: 'handcraft' }, { text: 'music', value: 'music' }, { text: 'finance', value: 'finance' }, { text: 'game', value: 'game' }, { text: 'movie', value: 'movie' }, { text: 'drawing', value: 'drawing' }, { text: 'book', value: 'book' }, { text: 'pet', value: 'pet' }]"
    :filter-method="filterCategory"
    filter-placement="right-start">
    </el-table-column>
    <el-table-column prop="viewDateFix" label="날짜" sortable>
    </el-table-column>
    <el-table-column prop="viewStartFix" label="시청 시작">
    </el-table-column>
    <el-table-column prop="viewEndFix" label="시청 끝">
    </el-table-column>
